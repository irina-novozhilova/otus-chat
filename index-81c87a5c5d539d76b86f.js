...
;// CONCATENATED MODULE: ./src/messagesApi.js
...
function getMessagesList() {
  return _getMessagesList.apply(this, arguments);
}
...
function _getMessagesList() {
  _getMessagesList = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          return _context.abrupt("return", fetch("".concat(config.firebaseBaseUrl, "/").concat(config.firebaseCollection), {
            headers: {
...
function _sendMessage() {
  _sendMessage = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(data) {
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          return _context2.abrupt("return", fetch("".concat(config.firebaseBaseUrl, "/").concat(config.firebaseCollection), {
            method: "POST",
...
function observeWithXHR(cb) {
  ...
  xhr.addEventListener("progress", function () {
    ...
    var body = xhr.response.substr(lastResponseLength);
    lastResponseLength = xhr.response.length;
    var eventType = body.match(/event: (.+)/)[1];
    var data = JSON.parse(body.match(/data: (.+)/)[1]);
    if (eventType === "put") {
      cb(data.data);
    }
  });
...
function observeWithEventSource(cb) {
  ...
  var evtSource = new EventSource("".concat(config.firebaseBaseUrl, "/").concat(config.firebaseCollection));
  evtSource.addEventListener("put", function (ev) {
...
const CHAT_LOADING_TYPE = "CHAT_LOADING";
const CHAT_SUCCESS_TYPE = "CHAT_SUCCESS";
const CHAT_ERROR_TYPE = "CHAT_ERROR";
const FORM_LOADING_TYPE = "FORM_LOADING";
const FORM_SUCCESS_TYPE = "FORM_SUCCESS";
const FORM_ERROR_TYPE = "FORM_ERROR";
function getChatLoadingAction() {
    return {
...
function getChatSuccessAction(data) {
    return {
...
function getChatErrorAction(error) {
    return {
...
function getFormErrorAction(error) {
    return {
...
const chatReducer = function chatReducer(state = initialState, action) {
    switch (action.type) {
        case CHAT_LOADING_TYPE:
            return Object.assign(Object.assign({}, state), { isLoading: action.payload.isLoading });
        case CHAT_SUCCESS_TYPE:
            return Object.assign(Object.assign({}, state), { isLoading: action.payload.isLoading, data: action.payload.data, error: "" });
        case CHAT_ERROR_TYPE:
            return Object.assign(Object.assign({}, state), { isLoading: action.payload.isLoading, data: "", error: action.payload.error });
        default:
            return state;
    }
};
const formReducer = function formReducer(state = initialState, action) {
    switch (action.type) {
        case FORM_LOADING_TYPE:
            return Object.assign(Object.assign({}, state), { isLoading: action.payload.isLoading });
        case FORM_SUCCESS_TYPE:
            return Object.assign(Object.assign({}, state), { isLoading: action.payload.isLoading, data: action.payload.data, error: "" });
...
;// CONCATENATED MODULE: ./src/smiles.ts
function initSmiles() {
    ...
    smiles.forEach((element) => {
        element.addEventListener("click", function click(event) {
            ...
            if (inputMessage) {
                inputMessage.value = `${inputMessage.value}##${this.getAttribute("href")}##`;
                inputMessage.focus();
            }
        });
    });
...
function parseSmiles(message) {
    ...
    const regex = /##(.+?)##/gi;
    if (parsedMessage) {
        parsedMessage = parsedMessage.replace(regex, '<img src="images/$1.svg" alt="">');
    }
...
async function getChatMessages() {
    ...
    try {
        // @ts-ignore
        const allMessages = await getMessagesList();
        let messagesHtml = "";
        allMessages.map((currentValue) => {
...
async function sendChatMessage(nickname, message) {
...
if (chatForm) {
    chatForm.addEventListener("submit", async function submit(event) {
        ...
        await sendChatMessage(String(formData.get("name")), String(formData.get("inputMessage")));
    });
}
observeWithEventSource(getChatMessages);
store.subscribe(render);

/******/ })()
;
//# sourceMappingURL=index-81c87a5c5d539d76b86f.js.map